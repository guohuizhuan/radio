...
* @note
*/
void progress_init(progress_bar_t *progress_bar,char *tip_title,char tip_char,char *buffer,uint16_t buffer_size,float max_value,uint8_t style)
{
...
* @note
*/
void progress_show(progress_bar_t *progress_bar, float value)
{
